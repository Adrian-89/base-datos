...
SELECT p.nombre, p.nivel, t.id FROM Pokemon AS p, tipo AS t WHERE p.id_tipo=t.id AND p.id_tipo=2;
...
SELECT count(p.nombre) as número_pokemon, t.nombre FROM Pokemon as p, tipo as t WHERE p.id_tipo=t.id GROUP BY t.nombre;
...
SELECT AVG(nivel) as nivel_medio FROM Pokemon;
...
SELECT p.nombre, t.nombre as tipo, p.nivel FROM Pokemon as p, tipo as t WHERE p.id_tipo=t.id and p.nombre='Pikachu';
...
SELECT p.nombre, t.nombre as tipo, p.nivel FROM Pokemon as p, tipo as t  WHERE p.id_tipo=t.id and p.nivel > 20 and t.nombre='Agua';
...
UPDATE tipo as t set nombre='Eléctrico/Azul' FROM Pokemon as p  WHERE p.id_tipo=t.id and t.nombre='Eléctrico/Rojo' and p.nombre='Pikachu';
...
SELECT p.nombre, t.nombre as tipo FROM Pokemon as p, tipo as t WHERE p.id_tipo=t.id ORDER BY p.nombre ASC;
/**
┌─────────────────┬────────────────┐
│     nombre      │     nombre     │
├─────────────────┼────────────────┤
...
SELECT nombre FROM Pokemon WHERE nombre like '%sa%';
...
SELECT p.nombre, t.nombre as tipo FROM Pokemon as p, tipo as t WHERE p.id_tipo=t.id and t.nombre='Fuego' and p.nombre like 'C%';
...
SELECT p.nombre, t.nombre as tipo, p.nivel FROM Pokemon as p, tipo as t WHERE p.id_tipo=t.id and p.nivel >= (SELECT AVG(nivel) from Pokemon);
